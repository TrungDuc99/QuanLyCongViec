...
//----test makestyles----
const useStylestest = makeStyles({
  root: {
...
export default function ScrollableTabsButtonForce() {
  //---test makestyles
  const classestest = useStylestest();
  ...
  return (
    <Box className={classes.root}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <Box className={classes.root}>
          <Accordion
            ...
            onChange={handleChangeinf("panel1")}
          >
            <AccordionSummary
          ...
          <Accordion
            ...
            onChange={handleChangeinf("panel2")}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
          ...
          <Accordion
            ...
            onChange={handleChangeinf("panel3")}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
          ...
          <Accordion
            ...
            onChange={handleChangeinf("panel4")}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
          ...
          <Accordion
            ...
            onChange={handleChangeinf("panel5")}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-controls="panel3bh-content"
          ...
          <Accordion
            ...
            onChange={handleChangeinf("panel6")}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-controls="panel3bh-content"
          ...
          <Accordion
            ...
            onChange={handleChangeinf("panel7")}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-controls="panel3bh-content"
          ...
          <Accordion
            ...
            onChange={handleChangeinf("panel8")}
          >
            <AccordionSummary
              expandIcon={<ExpandMoreIcon />}
              aria-controls="panel3bh-content"
          ...
          <FormControl>
            ...
            >
              <FormLabel component="legend">
                Chon thoi gian hoan thanh cong viec
              </FormLabel>
              <RadioGroup
                aria-label="quiz"
                name="ThoiGian"
      ...
      <TabPanel value={value} index={4}>
        ...
        <Button className={classestest.root}>Styled with Hook API</Button>
      </TabPanel>
    </Box>
  );
}

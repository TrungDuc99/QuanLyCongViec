        ...
        <Grid container justify="flex-start" className={classes.tabs}>
          ...
          <Grid item>
            <div
              ...
              onClick={() => handleTabChange("Trả về")}
            >
              <StyledBadge badgeContent={9999} max={999} color="primary">
                <Typography
                  variant="h6"
                  id="tableTitle"
                  component="div"
                  color={checkTab("Trả về")}
                >
                  Trả về
                </Typography>
              </StyledBadge>
          ...
          <Grid item>
            <div
              className={classes.tab}
              onClick={() => handleTabChange("Theo dõi")}
            >
          ...
          <Grid item>
            ...
            >
              <StyledBadge badgeContent={9999} max={999} color="default">
                <Typography
                  variant="h6"
                  id="tableTitle"
                  component="div"
          ...
          <Grid item>
            <div
              className={classes.tab}
              onClick={() => handleTabChange("BTGD trả về")}
            >
    ...
    <React.Fragment>
      <TableRow className={classes.root}>
        ...
        <TableCell>
          ...
          >
            <MenuItem onClick={sweetAlerts}>Xóa</MenuItem>
            <MenuItem
              onClick={() =>
                history.push(`/phong/tiepnhancongviec/xuly-cv/${row.namecv}`)
              }
            >
              Xử lý
            </MenuItem>
            <MenuItem onClick={sweetAlerts}>Chuyển</MenuItem>
          </Menu>
        </TableCell>
      </TableRow>
      <TableRow>
